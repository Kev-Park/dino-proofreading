...
classifier.run_train(input_dir=args.input_dir, output_dir=output_dir, num_epochs=args.epochs, learning_rate=args.lr, batch_size=args.batch_size, save_rate=args.save_rate)
